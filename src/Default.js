...
const mapStateToProps = (state) => {
    return {
        ...
        orders: state.orders ? state.orders.filter(order => order.status === 0 ): state.orders,
        orderGridData: state.orderGridData ? state.orderGridData.filter(order => order.status ===0) : state.orderGridData,
